 ...
 * "why DSQL" thesis. Judges can run two overlapping ledger writes and watch
 * DSQL abort the loser with SQLSTATE 40001, then watch our OCC retry recover
    ...
    <main className="mx-auto max-w-4xl px-4 py-10">
      ...
      <header className="mt-3">
        ...
        <p className="mt-3 max-w-2xl text-pretty leading-relaxed text-neutral-600">
          ...
          stay zero-sum. When two members write at once, DSQL&apos;s snapshot
